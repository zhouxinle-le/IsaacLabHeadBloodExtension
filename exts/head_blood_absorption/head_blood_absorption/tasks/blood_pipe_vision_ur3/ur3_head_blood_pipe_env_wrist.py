...
class Ur3BloodPipeVisionWristEnvCfg(DirectRLEnvCfg):
    ...
    pipe_blood_axis_margin = 0.012          # 血液被认为在管道轴线附近的额外边距，作用于奖励函数中的吸取奖励
...
class Ur3BloodPipeVisionWristEnv(DirectRLEnv):
    ...
    cfg: Ur3BloodPipeVisionWristEnvCfg

    def __init__(self, cfg: Ur3BloodPipeVisionWristEnvCfg, render_mode: str | None = None, **kwargs):
