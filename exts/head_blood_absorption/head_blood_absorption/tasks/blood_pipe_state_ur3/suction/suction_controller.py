...
from .geometry import compute_cone_and_inlet_masks, compute_particle_relation, compute_pipe_membership
...
class SuctionControllerNoTimer:
    ...
    def step(
        ...
        for env_idx in range(num_envs):
            ...
            valid_mask, _ = compute_pipe_membership(
                particles_pos,
                self.cfg,
                radius=float(self.cfg.pipe_blood_valid_radius),
            )
