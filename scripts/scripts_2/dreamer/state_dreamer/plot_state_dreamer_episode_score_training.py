...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plot multi-seed State Dreamer episode score curves.")
...
def main() -> None:
    ...
    csv_path = output_dir / "state_dreamer_episode_score_curves.csv"
