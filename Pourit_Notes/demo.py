...
class LiquidPredictor():
    def __init__(self, cfg, cam_type='kinect_azure'):
        ...
        # Publisher to communicate with Isaac Lab
        self.pub_image = rospy.Publisher('/heat_map', Image, queue_size=5)
    ...
    def inference(self, liquid_2d_only=True):
        ...
        while True:
            ...
            # Publish image for Isaac Lab
            cam_img_ros = self.cv_bridge.cv2_to_imgmsg(cam_img_show, 'bgr8')
            self.pub_image.publish(cam_img_ros)
...
if __name__ == "__main__":
    ...
    predictor = LiquidPredictor(cfg, cam_type='custom')
